...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding, 3, 0, 15),
  ...
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27),
  [263] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(45),
  [266] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(43),
  [269] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(47),
  [272] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(146),
  [275] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(88),
  [278] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(136),
  [281] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(248),
  [284] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(93),
  [287] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(19),
  [290] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(284),
  [293] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(71),
  [296] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(268),
  [299] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(33),
  [302] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(275),
  [305] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(49),
  [308] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(69),
  [311] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(91),
  [314] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 2, 0, 27), SHIFT_REPEAT(92),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding, 4, 0, 26),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binding, 5, 0, 31),
  ...
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_criteria, 3, 0, 21),
  [333] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_criteria, 3, 0, 21),
  ...
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 2, 0, 25),
  [350] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__value, 2, 0, 25),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keymap, 2, 0, 2),
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keymap, 1, 0, 0),
  [356] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_binding_repeat2, 1, 0, 17),
  [358] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_binding_repeat2, 1, 0, 17),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 3, 0, 29),
  [362] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__value, 3, 0, 29),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 3, 0, 9),
  [366] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__value, 3, 0, 9),
  [368] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 3, 0, 0),
  [370] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__value, 3, 0, 0),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 3, 0, 30),
  [374] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__value, 3, 0, 30),
  [376] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 4, 0, 32),
  [378] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__value, 4, 0, 32),
  ...
  [601] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_criteria_repeat1, 2, 0, 22),
  [603] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_criteria_repeat1, 2, 0, 22), SHIFT_REPEAT(116),
  ...
  [644] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_client, 4, 0, 20),
  ...
  [660] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_client_repeat1, 2, 0, 28),
  [662] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_client_repeat1, 2, 0, 28), SHIFT_REPEAT(134),
  ...
  [675] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gaps, 3, 0, 8),
  ...
  [687] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_client, 3, 0, 11),
  ...
  [703] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__criteria_value, 3, 0, 8),
  ...
  [715] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_border, 2, 0, 6),
  ...
  [727] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_criteria_repeat1, 1, 0, 13),
  ...
  [779] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_force_display_urgency_hint, 3, 0, 5),
  [781] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_smart_gaps, 2, 0, 0),
  [783] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mode, 3, 0, 18),
  [785] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gaps, 4, 0, 8),
  [787] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__workspace_switch, 3, 0, 19),
  [789] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__workspace_assign_output, 3, 0, 1),
  [791] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__workspace_switch, 2, 0, 10),
  [793] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_include, 2, 0, 7),
  ...
  [801] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign_workspace, 2, 0, 10),
  [803] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign_output, 2, 0, 0),
  [805] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set_from_resource, 4, 0, 23),
  ...
  [857] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hide_edge_borders, 2, 0, 5),
  [859] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_move, 2, 0, 5),
  ...
  [879] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_floating, 2, 0, 5),
  [881] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sticky_value, 1, 0, 0),
  [883] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sticky, 2, 0, 5),
  ...
  [913] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__focus_workspace, 2, 0, 9),
  ...
  [919] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_focus, 3, 0, 8),
  [921] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set, 3, 0, 14),
  ...
  [943] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_move, 3, 0, 8),
  ...
  [955] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_align, 2, 0, 5),
  ...
  [987] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_move, 4, 0, 33),
  ...
  [995] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_workspace_layout, 2, 0, 5),
  [997] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_default_orientation_value, 1, 0, 0),
  [999] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_swap, 5, 0, 34),
  [1001] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_move, 5, 0, 35),
  [1003] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_default_orientation, 2, 0, 5),
  [1005] = {.entry = {.count = 1, .reusable = true}}, SHIFT(147),
  [1007] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__resize_grow_shrink, 6, 0, 36),
  [1009] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [1011] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__resize_grow_shrink, 7, 0, 37),
  ...
  [1023] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tiling_drag_swap, 2, 0, 9),
  [1025] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_window, 3, 0, 15),
  [1027] = {.entry = {.count = 1, .reusable = true}}, SHIFT(153),
  [1029] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_border, 3, 0, 16),
